# Generated by Django 5.0.13 on 2025-09-23 13:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poll', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='quan_ly_phieu_bau.poll')),
            ],
        ),
        migrations.CreateModel(
            name='Ballot',
            fields=[
                ...
                ('poll', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='quan_ly_phieu_bau.poll')),
                ('voter', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='quan_ly_phieu_bau.voter')),
            ],
        ),
    ]
