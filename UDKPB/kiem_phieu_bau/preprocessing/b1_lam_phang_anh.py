...
def lam_phang_anh(duong_dan_anh_dau_vao, duong_dan_anh_dau_ra, chieu_ngang_cm, chieu_doc_cm, dpi=300):
    ...
    if qr_ref_point is not None and len(shared_markers_corners) >= 3:
        ...
        if phan_loai:
            ...
            print(f"[INFO] Đã phân loại marker và chọn góc phía trong theo tâm phiếu")
    ...
    print(f"[INFO] Kích thước đầu ra (với padding {padding}px): {chieu_rong_pixel_with_padding} x {chieu_dai_pixel_with_padding} pixels")
