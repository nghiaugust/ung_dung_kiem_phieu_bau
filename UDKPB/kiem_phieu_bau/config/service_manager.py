...
MODEL_KEYS = (MODEL_VIETNAMEOCR, MODEL_RESNET18_X, MODEL_RESNET18_CROSSED)

MODEL_ENDPOINTS = {
    MODEL_VIETNAMEOCR: "/api/model_vietnameocr/recognize/",
    MODEL_RESNET18_X: "/api/model_resnet18_x/detect/",
    MODEL_RESNET18_CROSSED: "/api/model_resnet18_crossed/detect/",
}

MODEL_BASE_URL_SETTINGS = {
    MODEL_VIETNAMEOCR: "AI_VIETNAMEOCR_BASE_URL",
    MODEL_RESNET18_X: "AI_RESNET18_X_BASE_URL",
    MODEL_RESNET18_CROSSED: "AI_RESNET18_CROSSED_BASE_URL",
}
...
COMPONENTS = {
    ...
    MODEL_RESNET18_X: {
        "id": MODEL_RESNET18_X,
        "label": "Model ResNet18 X",
        "description": "Nhan dien dau X hop le trong o dong y/khong dong y.",
        "kind": "ai_model",
    ...
    MODEL_RESNET18_CROSSED: {
        "id": MODEL_RESNET18_CROSSED,
        "label": "Model ResNet18 crossed",
        "description": "Nhan dien ten ung vien bi gach.",
        "kind": "ai_model",
