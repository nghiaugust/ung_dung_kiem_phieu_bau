...
SECRET_KEY = 'django-insecure-x1&kwi1%yq88w_087&v-tp3w!=7y*gee8p(^5f=)!&-xzk(v8s'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ['*']  # Cho phép mọi host (development)
...
MIDDLEWARE = [
    ...
    # Custom middleware cho performance logging
