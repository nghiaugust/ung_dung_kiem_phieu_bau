...
class PhieuBauProcessor:
    ...
    def __init__(self, 
        ...
        Args:
            ...
            num_rows: Số dòng của phiếu bầu (None = tự động)
            num_columns: Số cột của phiếu bầu (None = tự động)
        """
...
def main():
    ...
    parser.add_argument("--num_rows", type=int, default=None, help="Số dòng của phiếu bầu (bao gồm header)")
    parser.add_argument("--num_columns", type=int, default=None, help="Số cột của phiếu bầu")
    ...
    # Khởi tạo processor
    processor = PhieuBauProcessor(
        yolo_weights_path=args.weights,
        num_rows=args.num_rows,
        num_columns=args.num_columns
    )
    
    if args.num_rows or args.num_columns:
        print(f"[INFO] Sử dụng cấu hình: {args.num_rows} dòng x {args.num_columns} cột")
