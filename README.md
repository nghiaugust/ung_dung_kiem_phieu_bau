...
- `model_resnet18_x`: detect dau X hop le trong cot dong y/khong dong y.
- `model_resnet18_crossed`: detect ten ung vien bi gach trong cau hinh phieu gach ten.

## Cau hinh kiem phieu

- Cau hinh 1: phieu gach ten 1 cot + `model_resnet18_crossed`.
- Cau hinh 2: ten theo thu tu danh sach ung vien + `model_resnet18_x`.
- Cau hinh 3: `model_vietnameocr` + `model_resnet18_x`.
...
- `UDKPB/ai_core/model_resnet18_x`: ResNet18 X-mark classifier.
